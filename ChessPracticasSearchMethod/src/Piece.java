...
public class Piece {
	...
	public ArrayList<Action> getUpLeftMoves(State state){
		ArrayList<Action> list = new ArrayList<Action>(10);
		int agentColor = this.m_color;
	...
	public ArrayList<Action> getUpRightMoves(State state){
		ArrayList<Action> list = new ArrayList<Action>(10);
		int agentColor = this.m_color;
	...
	public ArrayList<Action> getDownRightMoves(State state){
		ArrayList<Action> list = new ArrayList<Action>(10);
		int agentColor = this.m_color;
	...
	public ArrayList<Action> getDownLeftMoves(State state){
		ArrayList<Action> list = new ArrayList<Action>(10);
		int agentColor = this.m_color;
